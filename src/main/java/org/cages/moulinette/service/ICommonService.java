...
public interface ICommonService {
	...
	public List<PointDeVenteDTO> loadAllPointDeVenteByCommuneId(Long idCommne)
			throws EntityDBDAOException; /* Lecture des point de vente d'une commune */
	...
	// List<MiseEnPlaceAEffectuer> loadAllMiseEnPlaceByCommuneId(Long idCommune)
	// throws EntityDBDAOException;
	...
	/***
	 * CAS : Dans un departement donné , on cherche toute les mise en place d'uree
	 * effectué :
	 * 
	 * @param idDepartlent
	 * @param idIntrant
	...
	// Lecture des mises en place du effectue sur un departement specique pour un
	// intrant specifique par periode
	/*
	 * List<MiseEnPlaceEffectuer>
	 * loadAllMiseEnPlaceEffectueeByDepartementAndIntrant(Long idDepartlent, Long
	 * idIntrant, String DateDebut, String dateFin) throws EntityDBDAOException;
	 */

	// Lecture de tous les mise en place d'un intran par periode (tout les
	// departmeent du SEN)
	/*
	 * public List<MiseEnplaceDTOPointDeVente>
	 * rechercherMiseEnplaceEffectueParIntrant(String searchdateDebut, String
	 * searchdateFin, Long idIntrant) throws EntityDBDAOException;
	 */
	 ...
	 * 
	 * Ce service recupere a partir de l'id du l'intrant les quotas qui sont liee
	 * (KOLDA + TAMBA + KAOLCAK)
	 * 
	 * @throws EntityDBDAOException
	 ****/
	...
	List<Quota> loadListQuotabyIdIntrantAndDepartement(Long idIntrant, Long idDepartement) throws EntityDBDAOException;
	...
	// Recherches des fournisseurs qui ont un produit spécfique (Ex : tous les
	// fournisseurs qui ont du NERICA 1)
	...
	// Apres mise en place on diminue le stock du fournisseur qui a distribué le
	// produit
	 ...
	 * 
	 * En plus du réféentiel des communes du Sénégal , on ajoute d'autres points de
	 * ventes spécifique à sedab
	 * 
	 * et Pour ces point de ventes spécifique , on les créé dans l'entity Commue et
	 * on les on tag commme local à sedab
	 * 
	 * ccommePointDevente.setCode("LOCAL-SEDAB-PV");
	 * 
	 * Ceci permettra de filtrer les communes officieles du sénégal pendant les
	 * filters
	 * 
	 */
	...
	// OL on filtre pas : lors de l'édition DOL on filtre pas par rapport au stock
	// du de DAKAR
