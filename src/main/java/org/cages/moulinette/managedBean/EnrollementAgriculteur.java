...
@ManagedBean(name = "EnrollementAgriculture")
@SessionScoped
@Getter
@Setter
public class EnrollementAgriculteur {

	private Logger logger = LoggerFactory.getLogger(EnrollementAgriculteur.class);
	...
	public String initEnrollementProcess() {
		loadListRegion();
		return "pgcaAgriculteurEdition.xhtml";
	}
