...
CREATE SEQUENCE hibernate_sequence INCREMENT 1 MINVALUE 1000 MAXVALUE 9223372036854775807 START 1000 CACHE 1;
...
--Sous Service
INSERT INTO public.sous_services( ssrv_id, code, libelle, srv_id) VALUES (0, 'SN', 'GOUV', 1);
INSERT INTO public.sous_services(ssrv_id, code, libelle, srv_id) VALUES (1, 'SSRV_INFO', 'Sous Service informatique', 1);

--- Groupe
INSERT INTO public.groupe(gr_id, code, libelle) VALUES (1, 'I', 'I');
INSERT INTO public.groupe(gr_id, code, libelle) VALUES (2, 'II', 'II');
