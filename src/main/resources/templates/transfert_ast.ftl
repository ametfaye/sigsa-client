    ...
    <tbody>
		...
		<tr><td>
			<table width="100%" border="0" cellspacing="0" cellpadding="0" >
				<tbody>
					<tr><td valign="top" width="660">
						<table style="border-width:1px; border-style:solid; border-color:#46BCEA;" width="660" border="0" cellspacing="0" cellpadding="0" align="center" class="MainContainer" bgcolor="#ffffff">
							<tbody>
							  <tr><td class='movableContentContainer'>
									<div class="movableContent" style="border: 0px; padding-top: 0px; position: relative;">
										<table width="100%" border="0" cellspacing="0" cellpadding="0" align="center" valign='top'>
											<tr><td height='10' bgcolor='#a6ddc2'></td></tr>
											<tr><td height='40' class='bgItem'></td></tr>
											<tr><td>
												<table width="100%" border="0" cellspacing="5" cellpadding="0" align="left" valign='top' class='bgItem'>
												  <tr>
													<td  width='70'></td>
													<td  align='left' width='100%'>
													  <div class='contentEditableContainer contentTextEditable'>
														<div class="contentEditable" style='font-size:32px;color:#555555;font-weight:normal;'>
														  ...
														  <img class="banner" src="" alt='Logo SIGMA' data-default="placeholder" data-max-width="200"  >
														</div>
													  </div>
													</td>
													<td  width='70'></td>
													...
													<td  align='left' width='100%'>
													  <div class='contentEditableContainer contentTextEditable'>
														<div class="contentEditable" style='font-size:13px;color:#99A1A6;line-height:19px;'>
														  <p>Bonjour ${civilite} ${prenom} ${nom},</p>
														  
														  <BR>
														   <p> Votre demande d’autorisation de sortie est transmise au secrétaire général de l’état pour validation. </p>
															
														   <BR>
														   <p> Merci de voir en attaché l’autorisation de sortie.</p>
														 
														   <BR>
														   <p>CE MESSAGE D’INFORMATION EST GENERE AUTOMATIQUEMENT, MERCI DE NE PAS Y REPONDRE.</p>
														   <BR>
															<p>
																Cordialement
																<BR>
