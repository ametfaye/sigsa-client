...
public class UtilisateurDTO implements Serializable {
	...
	private GedAbstractDocumentDTO gedDocumentDTO;
	...
	public void setFichierChangePassword(String fichierChangePassword) {
		this.fichierChangePassword = fichierChangePassword;
		if (UtilString.isCorrect(fichierChangePassword))
			setFichierChangePasswordExiste(true);
	}
	...
	public GedAbstractDocumentDTO getGedDocumentDTO() {
		return gedDocumentDTO;
	}

	public void setGedDocumentDTO(GedAbstractDocumentDTO gedDocumentDTO) {
		this.gedDocumentDTO = gedDocumentDTO;
	}
