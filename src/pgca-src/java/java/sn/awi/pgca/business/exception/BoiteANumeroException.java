 ...
 */
public class BoiteANumeroException extends Exception {
    /**
     ...
     */
    public BoiteANumeroException(String msg) {
        super(msg);
    }
     ...
     */
    public BoiteANumeroException(Throwable cause) {
        super(cause);
    }
     ...
     * @param cause         Cause � l'origine de l'erreur.
     */
    public BoiteANumeroException(String msg, Throwable cause) {
        super(msg, cause);
    }
}
